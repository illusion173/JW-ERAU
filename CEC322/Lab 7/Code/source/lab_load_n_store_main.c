...
int main(void) {   
	printf("\nResults of Task 10 by Jeremiah Webb\n");
	...
	printf("\nTask10: \n");
	for (int i = 0; i < gVar1; i++) {            
        printf("Value from C: %d; value from asm: %d \n", *(gPtrArray10c + i), *(gPtrArray10a + i));  
    } 
    ...
    printf("\nTask12: \n");
	for (int i = 0; i < gVar1; i++) {            
        printf("Value from C: %d; value from asm: %d \n", *(gPtrArray12c + i), *(gPtrArray12a + i));  
    } 
	printf("\nResults of Task 12 by Jeremiah Webb\n");
