 ...
 * inside each other.
 * 
 * @author Bobby Apelian, ERAU, October 2021
 * 
 *         Based on LayoutsDemo.java - The original FX implementation by Sean
 *         Holden, ERAU, October 2014 Based on ExampleLayout.java - a Swing
 *         implementation by N. Brixius, ERAU, March 2000
 *
 */
public class LayoutsDemo extends Application {
	...
	// Initialize Layouts Demo

	public void initLayoutsDemo() {
		...
		// 2.2
		tileBt4.setBackground(new Background(new BackgroundFill(Color.RED, null, null)));

		// 2.3a
		flowBt2.setFont(new Font("Comic Sans MS", 16));

		// 2.3b
		flowBt3.setFont(new Font("Comic Sans MS", 16));

		// 2.3C
		flowBt4.setFont(new Font("Comic Sans MS", 16));
		...
		// Add Shape to the pane
		regularPane.getChildren().add(rectangle);
